...
## Terminology
The product name in the UI is **More Mentally Stable X Experience**. Never use the word "digest" in code, templates, or docs. Weekly snapshots live in the `editions` table. The old `digests` table is renamed automatically on connect.
